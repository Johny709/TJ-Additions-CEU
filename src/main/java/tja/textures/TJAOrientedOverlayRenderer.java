...
public class TJAOrientedOverlayRenderer implements TextureUtils.IIconRegister {

    private final String basePath;
    private final TJAOverlayFace[] faces;
    private final String modID;
    private final String overlay;

    @SideOnly(Side.CLIENT)
    private Map<TJAOverlayFace, ActivePredicate> sprites;
    ...
    public TJAOrientedOverlayRenderer(String modID, String basePath, String overlay, TJAOverlayFace... faces) {
        this.modID = modID;
    ...
    public TJAOrientedOverlayRenderer(String modID, String basePath, TJAOverlayFace... faces) {
    ...
    public void registerIcons(TextureMap textureMap) {
        ...
        for (TJAOverlayFace overlayFace : this.faces) {
    ...
    public void render(CCRenderState renderState, Matrix4 translation, IVertexOperation[] ops, Cuboid6 bounds, EnumFacing frontFacing, boolean isActive, boolean hasProblem, boolean isWorking) {
        for (EnumFacing renderSide : EnumFacing.VALUES) {
            TJAOverlayFace overlayFace = TJAOverlayFace.bySide(renderSide, frontFacing);
            if (this.sprites.containsKey(overlayFace)) {
                ...
                TJATextures.renderFace(renderState, translation, ops, renderSide, bounds, renderSprite);
            }
        }
    }
