...
public class TJAChestRenderer implements IIconRegister {
    ...
    public TJAChestRenderer(String modid, String basePath) {
        this.modid = modid;
    ...
    public void registerIcons(TextureMap textureMap) {
        String formattedBase = this.modid + ":" + basePath;
    ...
    public void render(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline, EnumFacing rotation, float capRotation) {
        ...
        for (EnumFacing renderSide : EnumFacing.VALUES) {
            ...
            Textures.renderFace(renderState, translation, pipeline, renderSide, mainBox, baseSprite, BlockRenderLayer.SOLID);
        }
        ...
        for (EnumFacing renderSide : EnumFacing.VALUES) {
            ...
            Textures.renderFace(renderState, translation, pipeline, renderSide, capBox, capSprite, BlockRenderLayer.SOLID);
            Textures.renderFace(renderState, translation, pipeline, renderSide, lockBox, lockSprite, BlockRenderLayer.SOLID);
        }
    }
