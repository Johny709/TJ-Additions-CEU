...
public final class TooltipHelper {
    ...
    public static void pageText(List<String> tooltip, int maxPages, BiConsumer<List<String>, TooltipHandler> tipHandler) {
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)) {
            ...
            tooltip.add(Color.WHITE + I18n.format("tja.machine.universal.tooltip.page", TJAValues.thousandFormat.format(INSTANCE.getIndex() + 1), TJAValues.thousandFormat.format(INSTANCE.getEnd() + 1)));
            ...
            tooltip.add(I18n.format("tja.machine.universal.tooltip.page_info"));
        } else INSTANCE.reset();
    }
    ...
    public static void shiftText(List<String> tooltip, Consumer<List<String>> tip) {
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)) {
            tip.accept(tooltip);
            tooltip.add(TooltipHelper.blinkingText(Color.WHITE, 50, "tja.machine.universal.tooltip.shifted"));
        } else {
            tooltip.add(TooltipHelper.blinkingText(Color.WHITE, 50, "tja.machine.universal.tooltip.shift"));
            INSTANCE.reset();
        }
    }
    ...
    public static void shiftTextJEI(List<String> tooltip, Consumer<List<String>> tip) {
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)) {
            tip.accept(tooltip);
            tooltip.add(TooltipHelper.blinkingText(Color.WHITE, 50, "tja.machine.universal.tooltip.more_jei"));
        } else {
            tooltip.add(TooltipHelper.blinkingText(Color.WHITE, 50, "tja.machine.universal.tooltip.shift"));
            INSTANCE.reset();
        }
