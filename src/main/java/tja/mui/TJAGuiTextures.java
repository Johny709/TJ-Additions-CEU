...
public final class TJAGuiTextures {
    ...
    public static final UITexture TOGGLE_AUTO_PULL = UITexture.fullImage(resource("textures/gui/widgets/auto_pull_toggle"));
    ...
    public static final UITexture INTERFACE_SETTINGS_BASE_LEFT = UITexture.fullImage(resource("textures/gui/widgets/interface_settings_base_left"));
