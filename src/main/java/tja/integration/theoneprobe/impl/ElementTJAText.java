...
public class ElementTJAText implements IElement {

    private final String text;

    public ElementTJAText(String text) {
        this.text = text;
    }

    public ElementTJAText(ByteBuf byteBuf) {
    ...
    @Override
    public int getID() {
        return TheOneProbeModule.ELEMENT_TJA_TEXT;
    }

    static String formatLocaleText(String text) {
