...
public class ElementFluidStack implements IElement {
    ...
    public void render(int x, int y) {
        ...
        TJAGuiUtils.drawFluidForGui(this.fluidStack, this.fluidStack.amount, this.fluidStack.amount, x + 1, y + 1, this.getWidth() - 1, this.getHeight() - 2);
    ...
    @Override
    public int getID() {
        return TheOneProbeModule.ELEMENT_FLUIDSTACK;
    }
}
