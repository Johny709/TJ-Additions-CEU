        ...
        return ModularPanel.defaultPanel("me.pattern_interface.gui", 176, 292)
                ...
                .child(new Grid()
                        ...
                        .scrollable(new VerticalScrollData() {{
                            this.setScrollSize(superInterface.getInterfaceDuality().getPatterns().getSlots() * 18 / 9);
                        }})
                ...
                .child(new Grid()
                        ...
                        .size(40, 180)
                        .scrollable(new VerticalScrollData() {{
                            this.setScrollSize(superInterface.getInterfaceDuality().getInventoryByName("upgrades").getSlots() * 18 / 2);
                        }})
