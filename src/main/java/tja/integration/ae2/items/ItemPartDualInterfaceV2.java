...
import tja.integration.ae2.part.PartDualInterfaceV2;

import javax.annotation.Nonnull;
import javax.annotation.Nullable;
import java.util.List;

import static tja.integration.ae2.blocks.BlockSuperDualInterface.DUALITY_INSTANCE;
import static tja.integration.ae2.blocks.BlockSuperDualInterface.FLUID_DUALITY_INSTANCE;

public class ItemPartDualInterfaceV2 extends Item implements IPartItem<IPart> {

    public ItemPartDualInterfaceV2() {}

    @Override
    @SideOnly(Side.CLIENT)
    public void addInformation(@Nonnull ItemStack stack, @Nullable World worldIn, @Nonnull List<String> tooltip, @Nonnull ITooltipFlag flagIn) {
        if (!TJAValues.isModLoaded(TJAValues.AE2FC_MOD_ID))
            tooltip.add(I18n.format("tile.me.dual_interface_v2.description"));
    ...
    public IPart createPartFromItemStack(ItemStack itemStack) {
        return new PartDualInterfaceV2(itemStack);
    }
