...
import tja.integration.ae2.part.PartSuperUltimateInterface;
...
import static tja.integration.ae2.blocks.BlockSuperUltimateInterface.DUALITY_INSTANCE;
import static tja.integration.ae2.blocks.BlockSuperUltimateInterface.FLUID_DUALITY_INSTANCE;

public class ItemPartSuperUltimateInterface extends Item implements IPartItem<IPart> {

    public ItemPartSuperUltimateInterface() {}
    ...
    public IPart createPartFromItemStack(ItemStack itemStack) {
        return new PartSuperUltimateInterface(itemStack);
    }
