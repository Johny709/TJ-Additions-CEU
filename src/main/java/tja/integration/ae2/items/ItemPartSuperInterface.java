...
import static tja.integration.ae2.blocks.BlockSuperInterface.DUALITY_INSTANCE;

public class ItemPartSuperInterface extends Item implements IPartItem<IPart> {
    ...
    public IPart createPartFromItemStack(ItemStack itemStack) {
        return new PartSuperInterface(itemStack);
    }
