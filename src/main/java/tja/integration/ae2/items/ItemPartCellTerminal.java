...
import tja.integration.ae2.part.PartCellTerminal;

import javax.annotation.Nonnull;
import javax.annotation.Nullable;

public class ItemPartCellTerminal extends Item implements IPartItem<IPart> {

    public ItemPartCellTerminal() {}

    @Nullable
    @Override
    public IPart createPartFromItemStack(ItemStack itemStack) {
        return new PartCellTerminal(itemStack);
    }
