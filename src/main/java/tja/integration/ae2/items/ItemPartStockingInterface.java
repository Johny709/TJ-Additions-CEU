...
import static tja.integration.ae2.blocks.BlockStockingInterface.DUALITY_INSTANCE;

public class ItemPartStockingInterface extends Item implements IPartItem<IPart> {

    public ItemPartStockingInterface() {}
    ...
    public IPart createPartFromItemStack(ItemStack itemStack) {
        return new PartStockingInterface(itemStack);
    }
