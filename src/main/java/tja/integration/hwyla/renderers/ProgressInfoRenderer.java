...
public class ProgressInfoRenderer implements IWailaTooltipRenderer {
    ...
    public Dimension getSize(@Nonnull String[] strings, @Nonnull IWailaCommonAccessor iWailaCommonAccessor) {
        ...
        final String percentage = String.format("%s%%", TJAValues.thousandFormat.format(progress / maxProgress * 100));
    ...
    public void draw(@Nonnull String[] strings, @Nonnull IWailaCommonAccessor iWailaCommonAccessor) {
        ...
        GTGuiTextures.DISPLAY.draw(offsetX, 0, totalLength, 12);
    ...
    private UITexture getBarByColor(String color) {
        switch (color) {
            case "YELLOW": return TJAGuiTextures.BAR_YELLOW;
            case "GREEN": return TJAGuiTextures.BAR_GREEN;
            case "ORANGE": return TJAGuiTextures.BAR_ORANGE;
            default: return TJAGuiTextures.BAR_RED;
        }
    }
}
